...
class AttendExciteAttnProcessor:
    ...
    def __call__(self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None, fca_dependency_matrix = None,
                 ):
        # print('abababbababababbabh')
        # print('abababbababababbabh')
        # print('abababbababababbabh')
        # print('abababbababababbabh')
        # print('abababbababababbabh')
        ...
        if fca_dependency_matrix is not None:
            ...
            print('wwwwwwwwwwwwwwwwwwwwww')
            print('wwwwwwwwwwwwwwwwwwwwww')
            nb_heads = query.size(0)
            print('nb_heads', nb_heads)
            print('attention_probs', attention_probs.shape)
            focused_attention_mask = torch.repeat_interleave(fca_dependency_matrix.unsqueeze(1), nb_heads, dim=1)
            print('focused_attention_mask', focused_attention_mask.shape)
            step_value = 0.6 #if 'step_value' in cross_attention_kwargs else 0.6
            focus_weights = torch.einsum("bhqk,bhdk->bhqd", attention_probs[:, :, :focused_attention_mask.size(-1)],
            ...
            attention_probs[:, :, :, :focus_weights.size(-1)] += (focus_weights - 1) * 50
