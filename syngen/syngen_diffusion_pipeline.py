...
class SynGenDiffusionPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        output_encode = self.encode_prompt(
            prompt,
            device,
        ...
        if use_focused_attention ==1:
            prompt_embeds, negative_prompt_embeds, dependency_matrix, attribute_mask = output_encode
            cross_attention_kwargs = {'fca_dependency_matrix': dependency_matrix,
            ...
            prompt_embeds, negative_prompt_embeds = output_encode
